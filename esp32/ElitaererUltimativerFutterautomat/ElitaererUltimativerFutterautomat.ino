...
const char* SETUP_AP_SSID = "EU-Futterautomat-Setup";
...
<title>Elitaerer Ultimativer Futterautomat</title>
<style>
...
<body>
<main>
<header><div><h1>Elitaerer Ultimativer Futterautomat</h1><p>ESP32 Fluessigfutter-Dosierer</p></div><div class="status" id="status">idle</div></header>
<section class="grid">
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Elitaerer Ultimativer Futterautomat WLAN Setup</title>
<style>
body{margin:0;min-height:100vh;display:grid;place-items:center;background:radial-gradient(circle at top,#14263a,#050b14 62%);color:#f3f7fb;font-family:Arial,Helvetica,sans-serif}
...
<h1>Elitaerer Ultimativer<br>Futterautomat</h1>
...
<p class="hint">Setup-Hotspot: EU-Futterautomat-Setup · Passwort: futter1234 · Adresse: 192.168.4.1</p>
</form>
</body>
</html>
)rawliteral";
